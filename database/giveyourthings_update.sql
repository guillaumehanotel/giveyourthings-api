...
VALUES (1, 'Vélo rouge', 'Lorem Ipsum...', 'Don', 'État moyen', 1, 1, 2, false, '44.8333', '-0.5667', NOW(), NOW()),
       (2, 'Canapé en cuir', 'Lorem Ipsum...', 'Don', 'Comme neuf', 1, 13, null, false, '44.8233', '-0.5767', NOW(),
        NOW()),
       (3, 'Table basse', 'Lorem Ipsum...', 'Don', 'À Bricoler', 2, 6, 1, false, '44.8433', '-0.5867', NOW(), NOW()),
       (4, 'Sac à main', 'Lorem Ipsum...', 'Don', 'Comme neuf', 3, 5, null, false, '44.8533', '-0.5*67', NOW(), NOW()),
       (5, 'Tshirt enfant', 'Lorem Ipsum...', 'Don', 'État moyen', 2, 7, 3, false, '44.8633', '-0.6067', NOW(), NOW()),
       (6, 'Iphone 3', 'Lorem Ipsum...', 'Don', 'À Bricoler', 1, 6, null, false, '44.8733', '-0.6167', NOW(), NOW()),
       (7, 'Lit 2 places', 'Lorem Ipsum...', 'Don', 'Comme neuf', 2, 6, null, false, '44.8833', '-0.6267', NOW(),
        NOW()),
       (8, 'Chassures', '      Lorem Ipsum...', 'Don', 'État moyen', 3, 13, null, false, '44.8033', '-0.6367', NOW(),
        NOW()),
       (9, 'Pneus neige', 'Lorem Ipsum...', 'Don', 'Comme neuf', 1, 15, 3, false, '44.8133', '-0.6467', NOW(), NOW()),
       (10, 'Meuble de cuisine', 'Lorem Ipsum...', 'Don', 'À Bricoler', 2, 2, null, false, '44.8513', '-0.5567', NOW(),
        NOW()),
       (11, 'Lustre', 'Lorem Ipsum...', 'Don', 'Comme neuf', 3, 3, 1, false, '44.8333', '-0.5467', NOW(), NOW()),
       (12, 'Mirroir', 'Lorem Ipsum...', 'Don', 'État moyen', 1, 6, null, false, '44.8333', '-0.5367', NOW(), NOW()),
       (13, 'Boite de Lego', 'Lorem Ipsum...', 'Don', 'Comme neuf', 2, 5, null, false, '44.8333', '-0.5667', NOW(),
        NOW()),
       (14, 'Fauteuil', 'Lorem Ipsum...', 'Don', 'À Bricoler', 3, 9, 2, false, '44.8333', '-0.5667', NOW(), NOW()),
       (15, 'Draps blancs', 'Lorem Ipsum...', 'Don', 'État moyen', 2, 10, null, false, '44.8333', '-0.5667', NOW(),
        NOW()),
       (16, 'Robe', 'Lorem Ipsum...', 'Don', 'Comme neuf', 1, 4, null, false, '44.8333', '-0.5667', NOW(), NOW()),
       (17, 'Album AC/DC', 'Lorem Ipsum...', 'Don', 'À Bricoler', 2, 16, null, false, '44.8333', '-0.5667', NOW(),
        NOW()),
       (18, 'Tapis de salon', 'Lorem Ipsum...', 'Don', 'Comme neuf', 3, 15, null, false, '44.8333', '-0.5667', NOW(),
        NOW());
